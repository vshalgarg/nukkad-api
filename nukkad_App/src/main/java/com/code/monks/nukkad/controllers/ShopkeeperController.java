...
//import static com.code.monks.nukkad.enums.RoleEnum.STOREKEEPER;
...
public class ShopkeeperController {
    ...
    public ResponseEntity<CreateStorekeeperResponseDTO> updateCustomer(
        ...
        CreateStorekeeperResponseDTO updateStorekeeper = storekeeperService.updateStoreKeeper(id, dto);
